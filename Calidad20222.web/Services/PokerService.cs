...
{   
    ...
    private bool EsEscaleraReal(List<Carta> cartas)
    {
        ...
        if (grouping.Count() > 1)
            return false;
        if (cartas.ElementAt(0).Numero == 1 && cartas.ElementAt(1).Numero == 10 && cartas.ElementAt(2).Numero == 11 && cartas.ElementAt(3).Numero == 12 && cartas.ElementAt(4).Numero == 13)
            return true;
        return false;
    }
    ...
    private bool EsEscaleraColor(List<Carta> cartas)
    {
        ...
        {
            if (cartas.ElementAt(0).Numero == 1 && cartas.ElementAt(1).Numero == 10 && cartas.ElementAt(0).Numero == 11 && cartas.ElementAt(0).Numero == 12 && cartas.ElementAt(0).Numero == 13)
                return true;
